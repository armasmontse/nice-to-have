		...
		<div class="grid__container home__container--cta">
			<div class="grid__col-1-1--sm home__col-1-1--cta">
				<div class="home__box home__box--cta">
					<h3 class="home__ttl home__ttl--cta">Live a life full </br> of what you love</h3>
					<div class="home__cta-buttons-container">
						<a href="#" class="input__submit home__cta-button">
							<span class="home__cta-buttons-container-show-text">Crea un evento</span>
							<span class="home__cta-buttons-container-hide-text">Próximamente</span>
						</a>
						<a href="#" class="input__submit home__cta-button">
							<span class="home__cta-buttons-container-show-text">Visita la tienda</span>
							<span class="home__cta-buttons-container-hide-text">Próximamente</span>
						</a>
					</div>
					<input type="text" class="input" placeholder="Busca un evento (próximamente)">
				</div>
			</div>
		</div>
	</section>
